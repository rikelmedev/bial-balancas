  ...
  return (
    <footer className="bg-slate-950 py-16 text-center text-white relative">
      <div className="container mx-auto px-6">
        ...
        <a href="https://wa.me/5517996780438" className="inline-flex bg-gold-gradient text-brand-write px-12 py-4 rounded-full font-black animate-shimmer uppercase tracking-widest text-xs">
           Iniciar Atendimento
        </a>
