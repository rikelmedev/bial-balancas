...
export default function App() {
  ...
  return (
    <div className="overflow-x-hidden selection:bg-brand-gold/30">
      ...
      {/* NAVBAR */}
      <nav className="fixed top-5 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl bg-white/90 backdrop-blur-md rounded-full px-8 py-3 z-[100] flex justify-between items-center shadow-xl border border-white/20">
